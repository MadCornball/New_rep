...
class API(object):
    ...
    def __init__(
        ...
        api_secret="eqBMTZLnouSOgN0d0y1Mxrh1YFK7zIBozGmitqvAdyBCt3yKaeIOJv1dvRptQA9h",
        base_url=None,
        timeout=None,
        proxies=None,
    ...
    def buy(self, symbol, quantity, price):
        ...
        return self.sign_request("POST", endpoint, payload=params)
...
# Пример покупки
buy_response = api.buy(symbol="BTCUSDT", quantity=0.01, price=50000.0)
print("Buy Response:", buy_response)

# Пример продажи
sell_response = api.sell(symbol="BTCUSDT", quantity=0.01, price=60000.0)
